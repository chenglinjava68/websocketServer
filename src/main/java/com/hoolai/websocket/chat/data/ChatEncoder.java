package com.hoolai.websocket.chat.data;
...
import com.hoolai.websocket.chat.data.basic.BasicMessage;
import com.hoolai.websocket.chat.data.structure.StructuredMessage;
...
public class ChatEncoder implements Encoder.Text<ChatMessage>  {
    ...
    public String encode(ChatMessage cm) throws EncodeException {
        if (cm instanceof StructuredMessage) {
            String dataString = "";
            for (Iterator<String> itr = ((StructuredMessage) cm).getList().iterator(); itr.hasNext(); ) {
