...
public class ChatDecoder implements Decoder.Text<ChatMessage> {
    ...
    public ChatMessage decode(String s) throws DecodeException {
        if (s.startsWith(NewUserMessage.USERNAME_MESSAGE)) {
            ...
            List<String> usernameUpdate = parseDataString(s.substring(ChatMessage.CHAT_DATA_MESSAGE.length()));
    ...
    private static List<String> parseDataString(String dataString) {
